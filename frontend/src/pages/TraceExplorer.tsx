  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold text-ink">Agent Trace</h1>
          <p className="text-sm text-slate-600">Retrieval, response, claims, and counterfactual sensitivity.</p>
        </div>
      ...
      <form className="panel flex flex-col gap-3 p-4 md:flex-row" onSubmit={submit}>
        <label className="flex flex-1 items-center gap-2 border border-line bg-white px-3" style={{ borderRadius: 8 }}>
        ...
        <>
          <div className="grid gap-4 xl:grid-cols-[minmax(260px,1fr)_minmax(320px,1.2fr)_minmax(260px,1fr)]">
            ...
            <div className="panel p-4">
              <h2 className="text-sm font-semibold uppercase text-slate-500">Agent</h2>
              <div className="mt-4 space-y-4">
                <div>
                  <div className="text-xs font-semibold uppercase text-slate-500">Question</div>
                  <p className="mt-1 text-sm leading-6 text-slate-700">{query}</p>
                </div>
                <div>
                  <div className="text-xs font-semibold uppercase text-slate-500">Answer</div>
                  <p className="mt-1 text-xl font-semibold text-ink">{result.answer}</p>
                </div>
                <div>
                  <div className="text-xs font-semibold uppercase text-slate-500">Decision</div>
                  <p className="mt-1 inline-flex border border-teal bg-emerald-50 px-3 py-1 text-sm font-semibold text-teal" style={{ borderRadius: 8 }}>
                    {result.decision}
                  </p>
                </div>
          ...
          <div className="panel p-4">
            <h2 className="mb-3 text-sm font-semibold uppercase text-slate-500">Ground Provenance</h2>
            <MemoryGraph
              memories={memories}
